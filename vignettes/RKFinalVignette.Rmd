...
```{r first categorical table, include=TRUE, eval=TRUE}
...
```{r continuous table, eval=TRUE, include=TRUE}
myContTable(ContOutput)
```
## Testing the package: Example 2

For our second example, I will generate a sample dataset to use. I've included it in this package folder:
